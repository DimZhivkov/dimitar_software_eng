...
public class DataStorage {
     ...
     *
     * @return a list of all patients (never null)
     */
    ...
    public static void main(String[] args) {
        ...
        // Example of adding and retrieving patient records
        storage.addPatientData(1, 98.6, "BodyTemperature", System.currentTimeMillis());
